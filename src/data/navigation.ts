    ...
    items: [
      { title: "Introduction",  href: "/docs/intro",         status: "live" },
      {
        ...
        children: [
          ...
          { title: "Working example",       href: "/docs/alert/example",               status: "live" },
      ...
      },
      {
        ...
        status: "live",
        children: [
          { title: "B.A.D. Glossary",     href: "/docs/glossaries/bad",   status: "live" },
          { title: "C.A.T. Glossary",     href: "/docs/glossaries/cat",   status: "live" },
          { title: "C.L.E.A.R. Glossary", href: "/docs/glossaries/clear", status: "live" },
        ],
      },
    ],
  },
